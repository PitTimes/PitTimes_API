...
// Positions
var P1 = ['Max','Verstappen',RedBullC,'Red Bull Racing',110,"0","+1",Gain]
var P2 = ['Charles','Leclerc',FerrariC,'Ferrari',104,"GapEX","-1",Lose]
var P3 = ['Sergio','Perez',RedBullC,'Red Bull Racing',86,"GapEX","+0",Equal]
var P4 = ['George','Russell',MercedesC,'Mercedes',74,"GapEX","+0",Equal]
var P5 = ['Carlos','Sainz',FerrariC,'Ferrari',65,"GapEX","+0",Equal]
var P6 = ['Lewis','Hamilton',MercedesC,'Mercedes',46,"GapEX","+0",Equal]
var P7 = ['Lando','Norris',McLarenC,'McLaren',39,"GapEX","+0",Equal]
var P8 = ['Valtteri','Bottas',RomeoC,'Alfa Romeo',38,"GapEX","+0",Equal]
var P9 = ['Esteban','Ocon',AlpineC,'Alpine',30,"GapEX","+0",Equal]
var P10 = ['Kevin','Magnussen',HaasC,'Haas',15,"GapEX","+0",Equal]
var P11 = ['Yuki','Tsunoda',AlphatauriC,'Alphatauri',11,"GapEX","+1",Gain]
var P12 = ['Daniel','Riccardo',McLarenC,'McLaren',11,"GapEX","-1",Lose]
var P13 = ['Peirre','Gasly',AlphatauriC,'Alphatauri',6,"GapEX","+0",Equal]
var P14 = ['Sebastian','Vettel',AstonC,'Aston Martin',4,"GapEX","+0",Equal]
var P15 = ['Fernando','Alonso',AlpineC,'Alpine',3,"GapEX","+1",Gain]
var P16 = ['Alexander','Albon',WilliamsC,'Williams',3,"GapEX","-1",Lose]
