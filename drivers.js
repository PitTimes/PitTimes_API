...
// Positions
var P1 = ['Max', 'Verstappen', RedBullC, 'Red Bull Racing', 258,"0","+0",Equal]
var P2 = ['Charles', 'Leclerc', FerrariC, 'Ferrari', 178, "GapEX", "+0", Equal]
var P3 = ['Sergio', 'Perez', RedBullC, 'Red Bull Racing', 173,"GapEX","+0",Equal]
var P6 = ['George', 'Russell', MercedesC, 'Mercedes', 158, "GapEX", "+1", Gain]
var P5 = ['Carlos', 'Sainz', FerrariC, 'Ferrari', 156, "GapEX", "-1", Lose]
var P6 = ['Lewis', 'Hamilton', MercedesC, 'Mercedes', 146,"GapEX","+0",Equal]
var P7 = ['Lando', 'Norris', McLarenC, 'McLaren', 76, "GapEX", "+0", Equal]
var P8 = ['Esteban', 'Ocon', AlpineC, 'Alpine', 58, "GapEX", "+0", Equal]
var P9 = ['Valtteri','Bottas',RomeoC,'Alfa Romeo',46,"GapEX","+0",Equal]
var P10 = ['Fernando','Alonso',AlpineC,'Alpine',41,"GapEX","+0",Equal]
var P11 = ['Kevin', 'Magnussen', HaasC, 'Haas', 22, "GapEX", "+0", Equal]
var P12 = ['Daniel', 'Riccardo', McLarenC, 'McLaren', 19, "GapEX", "+0", Equal]
var P13 = ['Peirre', 'Gasly', AlphatauriC, 'Alphatauri', 16, "GapEX", "+0", Equal]
var P14 = ['Sebastian', 'Vettel', AstonC, 'Aston Martin', 16, "GapEX", "+0", Equal]
...
var P19 = ['Alexander', 'Albon', WilliamsC, 'Williams', 3, "GapEX", "-1", Lose]
