...
// Positions
var P1 = ['Max','Verstappen',RedBullC,'Red Bull Racing',125,"0","+0",Equal]
var P2 = ['Charles','Leclerc',FerrariC,'Ferrari',116,"GapEX","+0",Equal]
var P3 = ['Sergio','Perez',RedBullC,'Red Bull Racing',111,"GapEX","+0",Equal]
var P4 = ['George','Russell',MercedesC,'Mercedes',84,"GapEX","+0",Equal]
var P5 = ['Carlos','Sainz',FerrariC,'Ferrari',83,"GapEX","+0",Equal]
var P6 = ['Lewis','Hamilton',MercedesC,'Mercedes',50,"GapEX","+0",Equal]
var P7 = ['Lando','Norris',McLarenC,'McLaren',47,"GapEX","+0",Equal]
var P8 = ['Valtteri','Bottas',RomeoC,'Alfa Romeo',39,"GapEX","+0",Equal]
var P9 = ['Esteban','Ocon',AlpineC,'Alpine',30,"GapEX","+0",Equal]
var P10 = ['Kevin','Magnussen',HaasC,'Haas',15,"GapEX","+0",Equal]
var P11 = ['Yuki','Tsunoda',AlphatauriC,'Alphatauri',11,"GapEX","+0",Equal]
var P12 = ['Daniel','Riccardo',McLarenC,'McLaren',11,"GapEX","+0",Equal]
var P13 = ['Peirre','Gasly',AlphatauriC,'Alphatauri',6,"GapEX","+0",Equal]
var P14 = ['Sebastian','Vettel',AstonC,'Aston Martin',5,"GapEX","+0",Equal]
var P15 = ['Fernando','Alonso',AlpineC,'Alpine',3,"GapEX","+0",Equal]
var P16 = ['Alexander','Albon',WilliamsC,'Williams',3,"GapEX","+0",Equal]
var P17 = ['Lance','Stroll',AstonC,'Aston Martin',2,"GapEX","+0",Equal]
var P18 = ['Zhou','Guanyu',RomeoC,'Alfa Romeo',1,"GapEX","+0",Equal]
var P19 = ['Mick','Schumacher',HaasC,'Haas',0,"GapEX","+0",Equal]
