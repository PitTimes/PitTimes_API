...
// Driver Standings
var P1 = ['Max','Verstappen',RedBullC,'Red Bull Racing',181,"0","+0",Equal]
var P2 = ['Sergio','Perez',RedBullC,'Red Bull Racing',147,"GapEX","+0",Equal]
var P3 = ['Charles','Leclerc',FerrariC,'Ferrari',138,"GapEX","+0",Equal]
var P4 = ['Carlos','Sainz',FerrariC,'Ferrari',127,"GapEX","+1",Gain]
var P5 = ['George','Russell',MercedesC,'Mercedes',111,"GapEX","-1",Lose]
var P6 = ['Lewis','Hamilton',MercedesC,'Mercedes',93,"GapEX","+0",Equal]
var P7 = ['Lando','Norris',McLarenC,'McLaren',58,"GapEX","+0",Equal]
var P8 = ['Valtteri','Bottas',RomeoC,'Alfa Romeo',46,"GapEX","+0",Equal]
var P9 = ['Esteban','Ocon',AlpineC,'Alpine',39,"GapEX","+0",Equal]
var P10 = ['Fernando','Alonso',AlpineC,'Alpine',28,"GapEX","+0",Equal]
var P11 = ['Peirre','Gasly',AlphatauriC,'Alphatauri',16,"GapEX","+0",Equal]
var P12 = ['Kevin','Magnussen',HaasC,'Haas',16,"GapEX","+0",Equal]
var P13 = ['Sebastian','Vettel',AstonC,'Aston Martin',15,"GapEX","+0",Equal]
var P14 = ['Daniel','Riccardo',McLarenC,'McLaren',15,"GapEX","+0",Equal]
var P15 = ['Yuki','Tsunoda',AlphatauriC,'Alphatauri',11,"GapEX","+0",Equal]
var P16 = ['Zhou','Guanyu',RomeoC,'Alfa Romeo',5,"GapEX","+0",Equal]
var P17 = ['Mick','Schumacher',HaasC,'Haas',4,"GapEX","+4",Gain]
...
function driverStandings(){
    ...
    document.getElementsByTagName("driver_standings")[0].innerHTML = content
