...
var concontent = `<div class="title2"> <h1>2022 Constructor Standings<t>.</t><br></h1> <h2>Up-to-date Formula 1 2022 Constructor Standings</h2> <P1> ${p1c2} </P1> <P2> ${p2c2} </P2> <P3> ${p3c2} </P3> <P4> ${p4c2} </P4> <P5> ${p5c2} </P5> <P6> ${p6c2} </P6> <P7> ${p7c2} </P7> <P8> ${p8c2} </P8> <P9> ${p9c2} </P9> <P10> ${p10c2} </P10> </div>`
document.getElementsByTagName("cstandings").innerHTML = concontent
...
var drivcontent = `<div class="title2"> <h1>2022 Driver Standings<t>.</t><br></h1> <h2>Up-to-date Formula 1 2022 Driver Standings</h2> <P1> ${p1c} </P1> <P2> ${p2c} </P2> <P3> ${p3c} </P3> <P4> ${p4c} </P4> <P5> ${p5c} </P5> <P6> ${p6c} </P6> <P7> ${p7c} </P7> <P8> ${p8c} </P8> <P9> ${p9c} </P9> <P10> ${p10c} </P10> <P11> ${p11c} </P11> <P12> ${p12c} </P12> <P13> ${p13c} </P13> <P14> ${p14c} </P14> <P15> ${p15c} </P15> <P16> ${p16c} </P16> <P17> ${p17c} </P17> <P18> ${p18c} </P18> <P19> ${p19c} </P19> <P20> ${p20c} </P20> <P21> ${p21c} </P21> </div>`
document.getElementsByTagName("dstandings").innerHTML = drivcontent
